...
export interface PostV1PartnersGetResponse {
    id: string;
    type: PostV1PartnersGetResponse.Type;
    name: string;
    code: string | null;
    vatCode: string | null;
    ...
    correspondenceAddress: PostV1PartnersGetResponse.CorrespondenceAddress | null;
    notes: string | null;
    ...
    isActive: boolean;
    legalCountryClass: PostV1PartnersGetResponse.LegalCountryClass | null;
    createdAt: string;
    updatedAt: string;
}

export namespace PostV1PartnersGetResponse {
    export const Type = {
        Company: "company",
        Person: "person",
    } as const;
