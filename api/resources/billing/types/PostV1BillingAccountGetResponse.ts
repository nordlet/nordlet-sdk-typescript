...
export interface PostV1BillingAccountGetResponse {
    plan: PostV1BillingAccountGetResponse.Plan;
    status: PostV1BillingAccountGetResponse.Status;
    balanceCents: number;
...
export namespace PostV1BillingAccountGetResponse {
    export const Plan = {
        Starter: "starter",
        Business: "business",
        Scale: "scale",
