...
export interface PostV1PurchasesOrdersCancelResponse {
    id: string;
    partnerId: string;
    status: PostV1PurchasesOrdersCancelResponse.Status;
    orderNumber: string;
    orderDate: string;
...
export namespace PostV1PurchasesOrdersCancelResponse {
    export const Status = {
        Draft: "draft",
        Submitted: "submitted",
        Approved: "approved",
