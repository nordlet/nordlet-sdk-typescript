...
export interface PostV1PurchasesOrdersCloseResponse {
    id: string;
    partnerId: string;
    status: PostV1PurchasesOrdersCloseResponse.Status;
    orderNumber: string;
    orderDate: string;
...
export namespace PostV1PurchasesOrdersCloseResponse {
    export const Status = {
        Draft: "draft",
        Submitted: "submitted",
        Approved: "approved",
