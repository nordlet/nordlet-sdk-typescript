...
export interface PostV1PurchasesOrdersRejectResponse {
    id: string;
    partnerId: string;
    status: PostV1PurchasesOrdersRejectResponse.Status;
    orderNumber: string;
    orderDate: string;
...
export namespace PostV1PurchasesOrdersRejectResponse {
    export const Status = {
        Draft: "draft",
        Submitted: "submitted",
        Approved: "approved",
