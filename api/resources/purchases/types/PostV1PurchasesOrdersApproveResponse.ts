...
export interface PostV1PurchasesOrdersApproveResponse {
    id: string;
    partnerId: string;
    status: PostV1PurchasesOrdersApproveResponse.Status;
    orderNumber: string;
    orderDate: string;
...
export namespace PostV1PurchasesOrdersApproveResponse {
    export const Status = {
        Draft: "draft",
        Submitted: "submitted",
        Approved: "approved",
