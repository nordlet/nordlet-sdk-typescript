...
export interface PostV1PurchasesOrdersCreateResponse {
    id: string;
    partnerId: string;
    status: PostV1PurchasesOrdersCreateResponse.Status;
    orderNumber: string;
    orderDate: string;
...
export namespace PostV1PurchasesOrdersCreateResponse {
    export const Status = {
        Draft: "draft",
        Submitted: "submitted",
        Approved: "approved",
