...
export declare namespace AuditClient {
...
export class AuditClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<AuditClient.Options>;

    constructor(options: AuditClient.Options) {
    ...
    private async __postV1AuditList(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v1/audit/list");
    }
}
