...
export interface PostV1SalesInvoicesUnlockResponse {
    id: string;
    partnerId: string;
    type: PostV1SalesInvoicesUnlockResponse.Type;
    status: PostV1SalesInvoicesUnlockResponse.Status;
    paymentStatus: PostV1SalesInvoicesUnlockResponse.PaymentStatus;
    series: string | null;
    number: number | null;
    ...
    vatScheme: PostV1SalesInvoicesUnlockResponse.VatScheme | null;
    ...
    createdAt: string;
    updatedAt: string;
    lines: PostV1SalesInvoicesUnlockResponse.Lines.Item[];
    vatEvidence: PostV1SalesInvoicesUnlockResponse.VatEvidence | null;
}

export namespace PostV1SalesInvoicesUnlockResponse {
    export const Type = {
        Invoice: "invoice",
