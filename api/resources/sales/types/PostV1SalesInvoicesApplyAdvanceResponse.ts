...
export interface PostV1SalesInvoicesApplyAdvanceResponse {
    id: string;
    partnerId: string;
    type: PostV1SalesInvoicesApplyAdvanceResponse.Type;
    status: PostV1SalesInvoicesApplyAdvanceResponse.Status;
    paymentStatus: PostV1SalesInvoicesApplyAdvanceResponse.PaymentStatus;
    series: string | null;
    number: number | null;
    ...
    vatScheme: PostV1SalesInvoicesApplyAdvanceResponse.VatScheme | null;
