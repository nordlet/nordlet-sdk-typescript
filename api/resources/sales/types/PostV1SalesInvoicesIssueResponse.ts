...
export interface PostV1SalesInvoicesIssueResponse {
    id: string;
    partnerId: string;
    type: PostV1SalesInvoicesIssueResponse.Type;
    status: PostV1SalesInvoicesIssueResponse.Status;
    paymentStatus: PostV1SalesInvoicesIssueResponse.PaymentStatus;
    series: string | null;
    number: number | null;
    ...
    vatScheme: PostV1SalesInvoicesIssueResponse.VatScheme | null;
    ...
    vatEvidence: PostV1SalesInvoicesIssueResponse.VatEvidence | null;
}

export namespace PostV1SalesInvoicesIssueResponse {
    export const Type = {
        Invoice: "invoice",
