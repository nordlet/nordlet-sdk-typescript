...
export interface PostV1SalesInvoicesUpdateResponse {
    id: string;
    partnerId: string;
    type: PostV1SalesInvoicesUpdateResponse.Type;
    status: PostV1SalesInvoicesUpdateResponse.Status;
    paymentStatus: PostV1SalesInvoicesUpdateResponse.PaymentStatus;
    series: string | null;
    number: number | null;
    ...
    vatEvidence: PostV1SalesInvoicesUpdateResponse.VatEvidence | null;
}

export namespace PostV1SalesInvoicesUpdateResponse {
    export const Type = {
        Invoice: "invoice",
