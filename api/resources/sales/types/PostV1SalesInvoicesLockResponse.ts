...
export interface PostV1SalesInvoicesLockResponse {
    id: string;
    partnerId: string;
    type: PostV1SalesInvoicesLockResponse.Type;
    status: PostV1SalesInvoicesLockResponse.Status;
    paymentStatus: PostV1SalesInvoicesLockResponse.PaymentStatus;
    series: string | null;
    number: number | null;
    ...
    vatEvidence: PostV1SalesInvoicesLockResponse.VatEvidence | null;
}

export namespace PostV1SalesInvoicesLockResponse {
    export const Type = {
        Invoice: "invoice",
