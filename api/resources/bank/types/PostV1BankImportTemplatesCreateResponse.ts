...
export interface PostV1BankImportTemplatesCreateResponse {
    id: string;
    name: string;
    type: PostV1BankImportTemplatesCreateResponse.Type;
    fields: PostV1BankImportTemplatesCreateResponse.Fields.Item[];
    metaFields: string[];
...
export namespace PostV1BankImportTemplatesCreateResponse {
    export const Type = {
        Stripe: "stripe",
        Iso20022: "iso20022",
